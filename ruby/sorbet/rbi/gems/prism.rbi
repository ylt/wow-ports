...
class Prism::CallNode < Prism::Node
  ...
  def comment_targets; end
  def compact_child_nodes; end
  def copy(node_id: nil, location: nil, flags: nil, receiver: nil, call_operator_loc: nil, name: nil, message_loc: nil, opening_loc: nil, arguments: nil, closing_loc: nil, equal_loc: nil, block: nil); end
  def deconstruct; end
  def deconstruct_keys(keys); end
  def each_child_node; end
  def equal; end
